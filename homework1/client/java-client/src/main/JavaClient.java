...
public class JavaClient {
    ...
    public static final String serverUrlGoAws = "http://ec2-54-218-76-170.us-west-2.compute.amazonaws.com:8080/albums";
    public static final String serverUrlJavaAws = "http://ec2-54-218-76-170.us-west-2.compute.amazonaws.com:8080/cs6650hw1daniel_ec2/albums";
    ...
    public static void serverExecute(int tasksPerThread, int threadPerGroup, int groupCount, String serverUrl,
        ...
        for (int group = 0; group < groupCount; group++) {
            for (int i = 0; i < threadPerGroup; i++) {
                threads[group][i] = new Thread(new RequestWorker(serverUrl, latch, tasksPerThread, queue));
